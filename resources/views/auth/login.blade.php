                                    ...
                                    <div class="card p-4 rounded-plus bg-faded">
                                        <form id="js-login" novalidate="" method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" id="username" name="email" class="form-control form-control-lg" placeholder="your id or email" type="email" name="email" :value="old('email')" required autofocus>
                                            ...
                                            <div class="form-group text-left">
                                                <div class="custom-control custom-checkbox">
                                                    ...
                                                    <label class="custom-control-label" name="remember" for="rememberme">{{ __('Beni Hatırla') }}</label>
                                                </div>
                                            </div>
